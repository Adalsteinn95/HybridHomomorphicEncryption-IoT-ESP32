...
namespace AGRASTA
{
  ...
  void AGRASTA_128_TFHE::encrypt_key()
  {
  ...
  TFHECiphertextVec AGRASTA_128_TFHE::HE_decrypt(
  ...
  std::vector<uint8_t> AGRASTA_128_TFHE::decrypt_result(
  ...
  void AGRASTA_128_TFHE::MultiplyWithGF2Matrix(const std::vector<block> &matrix,
  ...
  void AGRASTA_128_TFHE::addConstant(TFHECiphertextVec &state,
  ...
  void AGRASTA_128_TFHE::add(TFHECiphertextVec &state, TFHECiphertextVec &key)
  {
    for (size_t i = 0; i < params.cipher_size_bits; i++)
    {
  ...
  void AGRASTA_128_TFHE::sboxlayer(TFHECiphertextVec &state)
  {
    TFHECiphertextVec out(params.cipher_size_bits, context);
