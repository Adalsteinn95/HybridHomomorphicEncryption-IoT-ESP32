...
namespace RASTA_6
{
  ...
  void RASTA_128_HElib::MultiplyWithGF2Matrix(const std::vector<block> &matrix,
  ...
  void RASTA_128_HElib::addConstant(std::vector<Ctxt> &state,
  ...
  void RASTA_128_HElib::add(std::vector<Ctxt> &state,
  ...
  void RASTA_128_HElib::sboxlayer(std::vector<Ctxt> &state)
  {
    std::vector<Ctxt> out;
