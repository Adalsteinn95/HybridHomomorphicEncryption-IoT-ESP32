...
namespace AGRASTA
{
  ...
  void AGRASTA_128_SEAL::encrypt_key()
  {
  ...
  std::vector<Ciphertext> AGRASTA_128_SEAL::HE_decrypt(
      std::vector<uint8_t> &ciphertexts, size_t bits)
  {
    ...
    {
      agrasta.genInstance(0, i + 1, false);
  ...
  std::vector<uint8_t> AGRASTA_128_SEAL::decrypt_result(
  ...
  void AGRASTA_128_SEAL::MultiplyWithGF2Matrix(const std::vector<block> &matrix,
  ...
  void AGRASTA_128_SEAL::addConstant(std::vector<Ciphertext> &state,
  ...
  void AGRASTA_128_SEAL::add(std::vector<Ciphertext> &state,
  ...
  void AGRASTA_128_SEAL::sboxlayer(std::vector<Ciphertext> &state)
  {
    std::vector<Ciphertext> out;
