...
class KreyviumTfheHandler : public ICipherHandler
{
private:
    const std::string result_topic = KREYVIUM_TFHE_COMPUTE_TOPIC;
    const std::string worker_name = "KREYVIUM_TFHE_WORKER";

    std::unique_ptr<KREYVIUM::KREYVIUM_TFHE> tfhe_impl_ptr;
