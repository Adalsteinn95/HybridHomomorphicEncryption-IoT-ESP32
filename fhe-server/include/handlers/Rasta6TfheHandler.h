...
class Rasta6TfheHandler : public ICipherHandler
{
private:
    const std::string result_topic = RASTA6_TFHE_RESULT_TOPIC;
    const std::string worker_name = "RASTA6_TFHE_WORKER";

    std::unique_ptr<RASTA_6::RASTA_128_TFHE> tfhe_impl_ptr;
