...
class Rasta6SealHandler : public ICipherHandler
{
private:
    ...
    const std::string result_topic = RASTA6_SEAL_RESULT_TOPIC;
    const std::string worker_name = "RASTA6_SEAL_WORKER";
...
public:
    Rasta6SealHandler();
    ~Rasta6SealHandler() override = default;
